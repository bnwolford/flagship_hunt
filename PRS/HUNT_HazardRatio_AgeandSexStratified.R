...
names(results)<-c("phenotype", "prs", "sex", "minage", "maxage", "medianAAO", "groups", "controls", "cases", "betas", "std_errs", "pvals", "HR", "CIpos", "CIneg")
write.csv(results, paste0(output_dir,"HR_AgeandSexStratified",biobank_name,".csv"))
